...
frc_mod<-nc_open(paste0(path_input, 'SEAS5-c3s_precip_startday_21August_1993_2017.nc'))
frc_raw<-ncvar_get(frc_mod, "frc_raw")

ob<-nc_open(paste0(path_input, 'JRA-55_precip_startday_21August1993_2017.nc'))
